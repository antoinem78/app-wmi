...
| Entity portals (wmiltd GBP, FZCO USD/AED) | LIVE; both proven. **[Code 2026-09-03: "wmiltd funnel unrehearsed" is false. The wmiltd funnel ran end to end on 2026-08-06 with a £1 live Stripe checkout (test client WE BET, deleted by the founder 2026-09-03, row confirmed gone; the £1 refund is not verifiable from Code because the live Stripe key is not on this machine); the portal DB holds 3 paid rows plus history.]** Upsells (one-off and recurring, signable quote for recurring) built 2026-08-11 on both portals, never yet used on a live client | platform architecture, R14 |
...
| 6 | §7: "wmiltd funnel unrehearsed" | False | Portal DB read 2026-09-03: 4 `onboarding_state` rows with `payment_status = paid`; test client `WE BET` created 2026-08-06 12:51 UTC by a live £1 Stripe checkout on app.wmiltd.com. Deleted 2026-09-03; refund unverified from Code. |
