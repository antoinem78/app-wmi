...
- [Name the denominator before agreeing a rate target](name-the-denominator-before-agreeing-a-rate-target.md) — a % criterion is two numbers; check the ceiling (paid share) before committing, and a rate above its ceiling means the numerator is leaking
