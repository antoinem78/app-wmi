...
metadata: 
  ...
  modified: 2026-09-01T16:56:20.405Z
---
...
**BANNED PHRASES, ruled 2026-09-01 after they had become tics across client, freelancer and founder-facing writing alike:**

- **"your instinct is right"**, and its relatives ("you were right to", "your instinct holds", "good catch"). Sycophantic filler. If someone is right, act on what they said; the agreement is implied by doing so.
- **"quietly"**, as in "doing it quietly", "quietly leaving it out", "quietly your best value". A filler adverb that adds nothing.
- **"I would rather X than Y"**. This praises my own honesty instead of simply being honest. Say the thing directly: not "I would rather tell you that than present last month's conclusion as though it held", just state that it does not hold.

The common fault in all three is **performing a virtue rather than exercising it**. Announcing that you prefer candour is weaker than being candid, and telling someone their instinct was right is flattery wearing the clothes of analysis. Sweep for these before delivering, the same way em dashes get swept.
