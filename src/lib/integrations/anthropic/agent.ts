        ...
        details: {
          ...
          properties: {
            action: {
              ...
              properties: {
                kind: { type: "string", enum: ["add_negative_keyword", "add_shared_negative", "pause_campaign", "set_campaign_budget", "pause_ad_group", "pause_ad", "attach_shared_set", "detach_shared_set", "add_campaign_criterion", "remove_campaign_criterion", "set_bidding_strategy", "mc_set_title", "mc_set_price"] },
